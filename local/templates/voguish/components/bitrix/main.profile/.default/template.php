...
<p><input type="submit" class="custom-btn" name="code_submit_button" value="<?= GetMessage("main_profile_send")?>" /></p>
...
<table class="profile-table data-table">
	...
	?>
	<tr>
		<td><?= GetMessage("main_profile_title")?></td>
...
<table class="data-table profile-table">
	...
	<div class="custom-form-group">
        <input type="submit" class="custom-btn" name="save" value="<?=(($arResult["ID"]>0) ? GetMessage("MAIN_SAVE") : GetMessage("MAIN_ADD"))?>">&nbsp;&nbsp;
        <input type="reset" class="custom-btn" value="<?=GetMessage('MAIN_RESET');?>">
    </div>
</form>
