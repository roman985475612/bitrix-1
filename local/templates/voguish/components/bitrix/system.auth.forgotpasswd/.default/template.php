...
?>
<h3>
    <?= GetMessage('auth_header') ?><br>
    <small class="text-muted"><?= GetMessage("sys_forgot_pass_note_email")?></small>
</h3>
...
<form name="bform" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
    ...
    <div class="custom-form-group">
        ...
        <input type="text" name="USER_LOGIN" class="custom-form-control" value="<?=$arResult["USER_LOGIN"]?>" />
        <input type="hidden" name="USER_EMAIL" />
        <div class="form-text"><?= GetMessage("sys_forgot_pass_label")?></div>
    </div>
	...
	<div class="custom-form-group">
		<input type="submit" class="custom-btn" name="send_account_info" value="<?=GetMessage("AUTH_SEND")?>" />
	</div>
